...
* See [Example Solution](HeroesOfPymoli/HeroesOfPymoli_starter.md) for a reference on expected format.
...
* See [Example Solution](PyCitySchools/PyCitySchools_starter.md) for a reference on the expected format.
